  ...
  const Skilldisplay = () => {
    return ( <div className="grid lg:grid-cols-4 lg:gap-x-6 lg:gap-y-6 p-2 sm:grid-cols-2 sm:gap-x-40 sm:gap-y-8 sm:mr-44 lg:mr-10">
        {skillset.map((skill, index) => (
          <span
            key={index}
            className="px-4 py-2 bg-white/10 backdrop-blur-md border border-blue-400 justify-center text-center rounded-3xl lg:w-60 lg:text-xl text-white hover:bg-white/20 transition-all sm:w-40 backdrop-blur-md shadow-lg"
          >
